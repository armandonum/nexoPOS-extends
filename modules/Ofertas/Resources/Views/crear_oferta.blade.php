                        ...
                        <div class="w-full md:w-1/2">
                            <div class="space-y-6 bg-white p-4 rounded-lg shadow-md">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div>
                                        <label for="tipo_oferta" class="block text-sm font-medium text-gray-700">Tipo de Oferta</label>
                                        <select name="tipo_oferta" id="tipo_oferta" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                                            {{  }}
                                    </div>
